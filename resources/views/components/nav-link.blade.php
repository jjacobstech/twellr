...
? 'inline-flex items-center px-1 pt-1 border-b-2 border-navy-blue text-sm font-medium leading-5 text-gray-900
dark:text-gray-100 focus:outline-none focus:border-navy-blue transition duration-150 ease-in-out'
