...
@if (Auth::user()->role == 'admin')
    <div class="px-10 bg-white shadow-sm navbar">
        <div class="flex-1">
            <!-- Logo -->
            <a class="flex"
                href="@if (Auth::user()->role == 'admin') {{ route('admin.dashboard') }} @else {{ route('dashboard') }} @endif"
                wire:navigate>
                ...
                <div class="flex justify-between w-full md:w-full">
                    <div class="relative flex pb-5 md:pb-0 pt-3 md:pt-0 w-[100%] md:my-3">
                        <input type="search" id="search-dropdown" wire.model.live="search"
                            ...
                            class="font-bold block p-2.5 w-full  z-20 text-sm text-gray-900 bg-gray-200 rounded-l-lg border-0 active:border-0 hover:ring-1 hover:ring-gray-400 focus:border-0 focus:ring-0 border-navy-blue "
                        ...
                        <button type="submit"
                            ...
                            <svg class="w-4 h-4 text-[#fbaa0d]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex gap-2">
            <x-dropdown :contentClasses="'bg-transparent mt-0'" :class="'dropdown dropdown-end'">
                <x-slot name="trigger">
                ...
                <x-slot name="content">
                    <ul tabindex="0"
                        class="p-2 mt-3 text-black bg-white rounded-lg shadow menu menu-sm dropdown-content z-1 w-52">
                        <li>
                            <a class="justify-between hover:bg-gray-200">
                                Profile
                            </a>
                        </li>
                        <li><a class="hover:bg-gray-200">Settings</a></li>
                        <li><a class="hover:bg-gray-200">Logout</a></li>
                    </ul>
                </x-slot>
            </x-dropdown>
        </div>
        ...
        <div class="px-5 mx-auto md:px-2 max-w-7xl sm:px-6 lg:px-4">
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="flex items-center shrink-0">
                        <a class="flex"
                            ...
                            wire:navigate>
                            <x-application-logo class="block w-auto fill-current h-9" />
                            <img class="hidden md:h-5 md:px-3 md:my-1 md:block"
                                src="{{ asset('assets/twellr-text.png') }}" alt="">
                        </a>
                    </div>
                ...
                <div class="w-full sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->role != 'admin')
                        <div
                            class="justify-center w-100 md:flex  md:w-[10%] mt-3 text-[#b7c1ab] hidden hover:cursor-pointer">
                            <span class="w-5 h-5 pt-2 mx-1 ">
                                <svg class="w-5 h-5" viewBox="0 -3.5 29 29" version="1.1"
                            ...
                            <x-dropdown contentClass="mt-5" align="right" width="48"
                                class="shadow-2xl shadow-navy-blue">
                                <x-slot name="trigger">
                                    <button
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link x-show="{{ $isCreative }}" class="hidden text-bold md:block"
                                        :href="route('creative.upload')">
                                        <span>
                                            <svg class="inline-block w-5 h-5 fill-navy-blue " version="1.1"
                                                id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 384.97 384.97"
                                                xml:space="preserve">
                                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    ...
                                    <x-dropdown-link class='hidden md:block' :href="route('explore')" :active="request()->routeIs('explore')"
                                        wire:navigate>
                                    ...
                                    <x-dropdown-link class="hidden text-bold md:block" :href="route('blog')" wire:navigate>
                                        <span>
                                            <svg class="inline-block w-5 h-5 fill-current" id="Layer_1"
                                    ...
                                    <x-dropdown-link class="hidden text-bold md:block" :href="route('market.place')" wire:navigate>
                                        <span>
                                            <svg class="inline-block w-5 h-5 fill-current" fill="#000000"
        ...
        <div :class="{ 'block': open, 'hidden': !open }" class="fixed z-50 hidden w-screen h-10 sm:hidden">
            ...
            <div class="fixed w-screen pb-1 bg-white border-t border-gray-200 text-navy-blue">
                <div>
                    ...
                    <x-responsive-nav-link @click="notification = !notification" wire:navigate>
                        <span>
                        ...
                        <div class="px-5 transition-all duration-500 bg-gray-200" x-show="notification">
                        ...
                        <div class="px-5 transition-all duration-500 bg-gray-200" x-show="more">
                            ...
                            <x-responsive-nav-link :href="route('wallet')" wire:navigate>
                                <span>
                                    ...
                                    <svg class="inline-block w-5 h-5 fill-navy-blue"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                        <path fill="#001f54"
                                            d="M64 32C28.7 32 0 60.7 0 96L0 416c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-224c0-35.3-28.7-64-64-64L80 128c-8.8 0-16-7.2-16-16s7.2-16 16-16l368 0c17.7 0 32-14.3 32-32s-14.3-32-32-32L64 32zM416 272a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" />
                                    </svg>
                            ...
                            <x-responsive-nav-link x-show="{{ $isCreative }}" :href="route('creative.upload')">
                                <span>
