...
new #[Layout('layouts.app')] class extends Component {
    ...
    public function orderModal($product)
    {
        $this->order = Product::where('id', '=', $product)->first();
        $this->modal = true;
...
<div class="h-screen" x-data="{
    ...
    <div class="flex w-[100%]">
        ...
        <div class="relative bg-white w-screen md:w-[72%] lg:w-[80%] md:h-screen pb-5 md:pb-20">
            <div
                class="relative grid lw-full h-full gap-5 pt-1  overflow-y-scroll lg:grid-col-5 md:grid-cols-2 sm:grid-cols-2 px-5">
