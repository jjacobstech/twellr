...
new class extends Component {
    ...
    public function updateProfileInformation(): void
    {
        ...
        $userInfo = (object) ($validated = $this->validate([
            ...
            'account_no' => ['string', 'max:255', 'min:10', 'max:10'],
                            ...
                            <div class="col-span-12 md:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="text" wire:model.live="bank_name" id="bank_name" autocomplete="bank"
                                        required
                                        class="shadow-sm text-black  focus:ring-navy-blue focus:border-navy-blue block w-full sm:text-sm border-gray-300 rounded-md @error('bank_name') border-red-500 @enderror">
                                </div>
                            </div>
                            ...
                            <div class="col-span-12 md:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="text" wire:model.live="account_name" id="account_name"
                                        ...
                                        class="block w-full border-gray-300 rounded-md shadow-sm text-black  focus:ring-navy-blue focus:border-navy-blue sm:text-sm">
                                </div>
                            </div>
                            <div class="col-span-12 md:col-span-3">
                                ...
                                <div class="mt-1">
                                    ...
                                    <input type="text" wire:model.live="facebook" id="facebook"
                                        ...
                                        class="shadow-sm text-black  focus:ring-navy-blue focus:border-navy-blue block w-full sm:text-sm border-gray-300 rounded-md @error('facebook')
                                            border-red-500
                                        @enderror">
                                </div>
                            </div>
                            ...
                            <div class="col-span-12 md:col-span-3">
                                ...
                                <div class="mt-1">
                                    ...
                                    <input type="text" wire:model.live="instagram" id="instagram"
                                        autocomplete="social-media"
                                        class="shadow-sm  text-black focus:ring-navy-blue focus:border-navy-blue block w-full sm:text-sm border-gray-300 rounded-md @error('instagram')
                                            border-red-500
                                        @enderror">
                                </div>
                            </div>
                            <div class="col-span-12 md:col-span-3">
                                ...
                                <div class="mt-1 ">
                                    ...
                                    <input type="text" placeholder="Paste whatsapp link here"
                                        ...
                                        class="shadow-sm text-black focus:ring-navy-blue focus:border-navy-blue block w-full sm:text-sm border-gray-300 rounded-md @error('whatsapp')
                                            border-red-500
                                        @enderror">
                                </div>
                            </div>
