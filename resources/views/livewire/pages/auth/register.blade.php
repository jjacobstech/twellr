...
<div class="my-5 md:my-12 border-0">
    <h1 class="w-full my-1 mb-5 text-3xl md:text-4xl text-center font-bold md:text-left ">Create Account</h1>
    <div>
    ...
    <form wire:submit="register" enctype="multipart/form-data">
        ...
        <div class="">
            <div class="md:flex justify-evenly">
                <div
                    class="md:w-1/2 md:py-3 lg:py-0 mb-3 md:text-left font-semibold lg:pr-10 md:text-lg md:font-bold  text-center">
            ...
            <div class="relative pt-1 pr-2 mt-24 w-100">
                <x-input-label class="absolute z-50 px-1 mt-1 md:mt-2 ml-3 font-extrabold bg-white" for="password"
                    :value="__('Password')" />
